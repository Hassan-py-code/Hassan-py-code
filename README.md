...
<p align="center" style="background-color: black;padding-top: 10px;">
  <a href="https://github.com/DenverCoder1/readme-typing-svg" >
    ...
    &vCenter=true
    &width=500
    &lines=Welcome+to+my+GitHub+Profile!;I'm+a+Web+Developer;I+love+Coding+💻" />
  </a>
</p>

 <div style="display: flex;align-items: start; justify-content: center; gap: 30px;"> 
     <div style="max-width: 600;">
        <h1>  <img src = "https://media2.giphy.com/media/QssGEmpkyEOhBCb7e1/giphy.gif?cid=ecf05e47a0n3gi1bfqntqmob8g9aid1oyj2wr3ds3mg700bl&rid=giphy.gif" width = 32px style="background-color: yellow; padding: 7px; border-left: 5px solid black; border-top-left-radius: 10px; border-bottom-left-radius: 10px;"> / About Me  /</h1>
  ...
  <img src="https://img.shields.io/badge/Study-Solicode-green?style=for-the-badge&logo=google-scholar&logoColor=white" />
    ...
    <img src="https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3cGo2ZTd0cmg5cTVxd2tkdWZ5d2o2cTQ0djR0a2lpMzRlMnM2ZzZmdiZlcD12MV9naWZzX3JlbGF0ZWQmY3Q9Zw/KdzF8XLE3FwXe/giphy.gif" alt="" width="400"  style="border-radius: 10px;" >
</p>
 ...
 <!-- Social media -->
  <div style="text-align: center;">
     <h2> <img height="40" src="https://emoji.gg/assets/emoji/7333-parrotdance.gif">
  Skills Showcase</h2>
<p>
